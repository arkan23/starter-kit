      ...
      <div id="page-sidebar">
        ...
        <div className="scroll-sidebar">
          <ul id="sidebar-menu">
            ...
            <li><a href="/" title="Admin Dashboard"><i className="glyph-icon icon-linecons-tv"></i> <span>Admin dashboard</span></a></li>
            ...
            <li><a href="javascript:void(0);" title="Pages"><i className="glyph-icon icon-linecons-fire"></i> <span>Pages</span> <span className="bs-label badge-yellow">NEW</span></a>
              <div className="sidebar-submenu">
                <ul>
                  <li><a href="/orders" title="View profile"><span>Orders</span></a></li>
                  ...
                  <li><a href="/salex" title="FAQ section"><span>FAQ section</span></a></li>
                  <li><a href="/automenu" title="Auto menu"><span>Auto menu</span></a></li>

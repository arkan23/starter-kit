                  ...
                  <div className="panel">
                    ...
                    <form className="form-horizontal bordered-row">
                      ...
                      <div className="form-group">
                        <label className="col-sm-1 control-label">Артикул</label>
                      ...
                      <div className="form-group">
                          <label className="col-sm-1 control-label">Количество</label>
                            <div className="col-sm-9">
                      ...
                      <div className="form-group">
                        <label className="col-sm-1 control-label">Номер партии</label>
                        <div className="col-sm-9">
                        ...
                        <div className="form-group">
                          <label htmlFor="" className="col-sm-1 control-label">Срок годности (дата)</label>
                          <div className="col-sm-9">
                      ...
                      <div className="form-group">
                        <label className="col-sm-1 control-label">Название</label>
                        <div className="col-sm-9">
                          <input type="text" className="form-control" id="" placeholder="Example placeholder..."/>
                        </div>
                      </div>
                      <div className="form-group">
                          <label className="col-sm-1 control-label">Примечание</label>
                          <div className="col-sm-9">
                            <textarea name="" id="" className="form-control"></textarea>
                          </div>
                      </div>
                      <div className="form-group">
                          <div className="col-sm-1 control-label"></div>
